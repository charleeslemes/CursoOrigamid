...
<?php
  ...
  $products_sales = wc_get_products([
    ...
    $data['categoria'][$categoria_esquerda] = get_product_category_data($categoria_esquerda);

    $data['categoria'][$categoria_direita] = get_product_category_data($categoria_direita);
