...
add_action('after_setup_rheme', 'handel_custom_images');
...
function format_products($products, $imgSize = 'medium'){
  $products_final = [];
  foreach($products as $product){
      $products_final[] =[
        ...
        'img'=> wp_get_attachment_image_src($product->get_image_id(), $imgSize)[0],
      ];
  }
